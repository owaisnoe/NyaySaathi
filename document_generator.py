...
# This dictionary acts as your "prebuilt library" of templates and fields.
DOC_CONFIG = {
...
def show_document_generator():
    ...
    with st.form("doc_form"):
        ...
        for i, field in enumerate(config["fields"]):
            # Determine which column to put this field in
            col = cols[i % 2] if field.get("type") != "textarea" else st 
